class Employee:
    ...
    def checkin(self, time):
        print(f'{self.__full_name} is checkin at {time}')

    def checkout(self, time):
        print(f'{self.__full_name} is checkout at {time}')
...
class Director(Employee):
    ...
    def sign(self, doc):
        print(f'Director {self.__full_name} signed at {doc}')

    def meeting(self, time):
        print(f'Director {self.__full_name} is attending a meeting at {time}.')
...
class Developer(Employee):
    ...
    def code(self, task):
        print(f'Dev {self.__full_name} is coding task {task}.')

    def fix_error(self, err):
        print(f'Dev {self.__full_name} is fixing error {err}.')

    def receive_task(self, task):
        print(f'Dev {self.__full_name} is receiving task {task}.')

    def report(self, to, typeof):
        print(f'Dev {self.__full_name} is sending a report of {typeof} to {to}.')
...
class ProjectManager(Developer):
    ...
    def calculate_salary(self, work_day):
        return super().calculate_salary(work_day) + 0.2 * self.__salary
...
class Tester(Employee):
    ...
    def receive_project(self, project):
        print(f'Tester {self.__full_name} receive project {project}.')

    def test(self, task):
        print(f'Tester {self.__full_name} is testing task {task}.')

    def write_testcase(self):
        print(f'Tester {self.__full_name} is writing tescases.')

    def report(self, to):
        print(f'Tester {self.__full_name} sent report to {to}.')
