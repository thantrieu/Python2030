...
def is_subject_name_valid(name):
    """
        ...
        Giả định tên hợp lệ chỉ chứa kí tự chữ cái, số và khoảng trắng.
    """
    if len(name.strip()) < 2:
...
def is_address_valid(address):
    """
        Phương thức kiểm tra địa chỉ nơi ở có hợp lệ không.
        Giả định địa chỉ hợp lệ chỉ chứa kí tự chữ cái, số và khoảng trắng.
    """
