...
if __name__ == '__main__':
    ...
    option = '============================ CÁC LỰA CHỌN ============================\n' \
             ...
             '25. Cập nhật ngày tháng năm sinh cho sinh viên theo mã sinh viên.\n' \
             '26. Cập nhật số tín chỉ cho môn học theo mã môn.\n' \
             '27. Cập nhật địa chỉ hiện tại cho sinh viên theo mã sinh viên.\n' \
             '28. Thay đổi môn học cho sinh viên trong bảng đăng ký theo mã sinh viên.\n' \
             '29. Xóa một môn học theo mã môn học.\n' \
             '30. Xóa một bản đăng ký của sinh viên theo mã sinh viên và mã môn.\n' \
             '31. Xóa tất cả các sinh viên có họ x nhập từ bàn phím.\n' \
             '32. Xóa các sinh viên có điểm TB < 3.0 khỏi bảng.\n' \
             '33. Xóa bỏ các sinh viên ở quận x nhập vào từ bàn phím.\n' \
             '34. Lưu dữ liệu vào CSDL.\n' \
             '35. Kết thúc chương trình.\n' \
             'Xin mời chọn chức năng(1-35): '
    while True:
        ...
        match choice:
            ...
            case 35:
                ...
                break
            case _:
                print('==> Lựa chọn không hợp lệ. Vui lòng nhập số 1-35. <==')
