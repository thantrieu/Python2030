...
sql = 'DELETE FROM student.py WHERE full_name LIKE %s'
data = ('%anh%',)
...
# sql = 'CREATE TABLE student.py (id VARCHAR(20) PRIMARY KEY, ' \
...
# ]
# sql = 'UPDATE student.py SET gpa = %s WHERE id = %s'
# data = (3.55, 'SV1008')
# sql = 'SELECT id, full_name, gpa FROM student.py WHERE full_name LIKE %s'
# data = ('%am%',)
# mycursor = mydb.cursor()
# mycursor.execute(sql, data)
